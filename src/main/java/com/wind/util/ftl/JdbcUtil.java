...
public class JdbcUtil {
    ...
    public static void genCommon(){
        FreeMarker freeMarker = new FreeMarker(FtlConst.FTL_JAVA);
        freeMarker.setFileDir(StringUtil.joinStr(Const.FILE_SEPARATOR, FtlConst.FTL_DIR, FtlConst.FTL_DAO, FtlConst.FTL_CALLBACK));
        freeMarker.setData("jdbc/psBack.ftl",  "PsBack.java");
        FtlUtil.genCode(freeMarker);

        freeMarker.setData("util/dbUtil.ftl", "DbUtil.java");
        freeMarker.setFileDir(FtlConst.FTL_DIR + FtlConst.FTL_UTIL);
        FtlUtil.genCode(freeMarker);
    ...
    public static void genDao(Table table, boolean flag){
        ...
        freeMarker.setFileDir(StringUtil.joinStr(Const.FILE_SEPARATOR, FtlConst.FTL_DIR, FtlConst.FTL_DAO, FtlConst.FTL_IMPL));
        FtlUtil.genCode(freeMarker);
    }
